...
#define nobs 25 // the number of the obstacle
...
class Guidance{
  public:
   ...
   void run(Point start,Point end, bool isAhead){
    ...
    int xo[nobs] = { 
      45,45,45,45,45,45,45,168,168,168,188,208,228,248,268,288,308,328,368,408,448,488,528,568,253
    };  // the position of obstacles
    int yo[nobs] = { 
      80,95,110,130,150,165,180,120,160,200,120,120,120,120,120,120,120,120,120,120,120,120,120,120,50
    };  // the position of obstacles
    
    // Size of obstacles (rho_0)
    int rho_0[nobs] = {
      35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,35,33
